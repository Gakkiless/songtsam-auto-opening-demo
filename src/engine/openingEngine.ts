...
export function generateOpeningPayload(openingPlan: OpeningPlan): OpeningPayload {
  ...
  return {
    ...
    channels: openingPlan.channels,
    groupSize: openingPlan.groupSize,
    priceConfig: openingPlan.priceConfig,
